		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="rle_btn_wrapper rle_toppadder40">
					<a href="view-property.html" class="rle_btn">View all properties</a>
				</div>
			</div>
		</div>
	</div>
...
<!-- Property Wrapper start -->
<div class="rle_property_wrapper rle_toppadder100 rle_bottompadder70 " style="background: url(images/bg1.jpg) no-repeat fixed center top; background-size: cover;">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="rle_center_heading rle_bottompadder60">
					<h1 style="color: #fff;">Featured Developers</h1>
					<p style="color: #fff;">Prominent developers in Mumbai</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="rle_property_infobox">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="rle_center_heading rle_bottompadder60">
					<h1>Latest news</h1>
					<p>News and Articles about realestate</p>
				</div>
			</div>
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="rle_news_slider3">
					<div class="owl-carousel owl-theme">
						<div class="item">
							<div class="rle_news_slider3_details">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="row">
										<img src="images/content/ltn4.jpg" alt="" title="">
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="row">
										<div class="rle_news_slider3_details_text">
											<span>October 10, 2017</span>
											<h4><a href="#">Low supply contributes to higher prices</a></h4>
											<p>Brisbane’s office towers are on the radar of international investors in a fundamental shift in favour.</p>
											<ul>
												<li><a href="#">Read more <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
											</ul>
										</div>
									</div>
								</div>
						...
						<div class="item">
							<div class="rle_news_slider3_details">
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="row">
										<img src="images/content/ltn5.jpg" alt="" title="">
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									<div class="row">
										<div class="rle_news_slider3_details_text">
											<span>October 10, 2017</span>
											<h4><a href="#">The resurgence of timber in architecture</a></h4>
											<p>Brisbane’s office towers are on the radar of international investors in a fundamental shift in favour.</p>
											<ul>
												<li><a href="#">Read more <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></li>
											</ul>
